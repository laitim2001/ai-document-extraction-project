      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium">
            {t.has(`fields.${field.fieldName}`) ? t(`fields.${field.fieldName}`) : field.fieldName}
          </span>
          ...
          {field.sourcePosition && (
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>{t('fieldMeta.sourcePositionTooltip', { page: field.sourcePosition.page })}</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          )}
          ...
          {isDirty && (
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>{t('fieldMeta.modifiedTooltip')}</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          )}
