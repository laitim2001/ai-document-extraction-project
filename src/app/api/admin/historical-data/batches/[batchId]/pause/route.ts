 ...
 *   - 停止處理新文件
 *
 * @module src/app/api/admin/historical-data/batches/[batchId]/pause
 ...
 *
 * @related
 *   - src/app/api/admin/historical-data/batches/[batchId]/resume/route.ts - 恢復處理
 */
...
/**
 * POST /api/admin/historical-data/batches/[batchId]/pause
 *
 * @description 暫停批量處理
 */
