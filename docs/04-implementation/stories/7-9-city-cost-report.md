...
- [x] **Task 1: 城市成本匯總 API** (AC: #1, #2)
  - [x] 1.1 創建 `GET /api/reports/city-cost` 端點
  - [x] 1.2 聚合各城市成本數據
  - [x] 1.3 計算人工成本估算
  - [x] 1.4 計算總成本

- [x] **Task 2: 成本趨勢 API** (AC: #3)
  - [x] 2.1 創建 `GET /api/reports/city-cost/trend` 端點
  - [x] 2.2 按月聚合歷史成本
  - [x] 2.3 計算環比變化

- [x] **Task 3: 異常檢測服務** (AC: #4)
  - [x] 3.1 定義成本異常閾值
  - [x] 3.2 實現異常檢測邏輯
  - [x] 3.3 生成異常原因分析

- [x] **Task 4: 成本報表頁面** (AC: #1, #5)
  - [x] 4.1 創建 `/reports/cost` 頁面路由
  - [x] 4.2 實現權限檢查
  - [x] 4.3 整合時間範圍篩選器

- [x] **Task 5: 城市成本表格** (AC: #2, #4)
  - [x] 5.1 創建 `CityCostTable` 組件
  - [x] 5.2 實現排序和篩選
  - [x] 5.3 添加異常警示標記
  - [x] 5.4 實現成本細節展開

- [x] **Task 6: 成本趨勢圖表** (AC: #3)
  - [x] 6.1 創建 `CostTrendChart` 組件（整合於 CityCostReportContent）
  - [x] 6.2 實現多城市對比視圖
  - [x] 6.3 添加異常高峰標記
  - [x] 6.4 實現互動式探索
