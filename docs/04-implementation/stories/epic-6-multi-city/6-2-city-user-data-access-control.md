...
- [x] **Task 1: 用戶城市綁定** (AC: #1)
  - [x] 1.1 在用戶創建時指定城市
  - [x] 1.2 在登入時載入城市資訊
  - [x] 1.3 將城市資訊存入 session
  - [x] 1.4 在 JWT token 包含城市代碼

- [x] **Task 2: API 層過濾** (AC: #1)
  - [x] 2.1 創建 `withCityFilter` API middleware
  - [x] 2.2 自動注入城市過濾條件
  - [x] 2.3 處理關聯查詢的城市過濾
  - [x] 2.4 驗證新增數據的城市歸屬

- [x] **Task 3: 資源訪問驗證** (AC: #2)
  - [x] 3.1 創建 `validateResourceAccess` 函數
  - [x] 3.2 在 API 路由檢查資源城市
  - [x] 3.3 處理跨城市訪問嘗試
  - [x] 3.4 返回適當的錯誤響應

- [x] **Task 4: 安全日誌記錄** (AC: #2)
  - [x] 4.1 創建安全事件日誌表
  - [x] 4.2 記錄跨城市訪問嘗試
  - [x] 4.3 包含用戶、資源、時間資訊
  - [x] 4.4 設置告警閾值

- [x] **Task 5: 儀表板數據隔離** (AC: #3)
  - [x] 5.1 修改儀表板 API 添加城市過濾
  - [x] 5.2 確保所有統計查詢包含城市條件
  - [x] 5.3 隱藏跨城市匯總功能
  - [x] 5.4 驗證圖表數據正確性

- [x] **Task 6: UI 城市顯示** (AC: #4)
  - [x] 6.1 在導航欄顯示城市標識
  - [x] 6.2 創建城市 Badge 組件
  - [x] 6.3 在頁面標題顯示城市名稱
  - [x] 6.4 移除城市切換選項（對城市用戶）

- [x] **Task 7: Session 城市管理** (AC: #1, #4)
  - [x] 7.1 擴展 NextAuth session 類型
  - [x] 7.2 在登入時獲取用戶城市
  - [x] 7.3 提供 useUserCity hook
  - [x] 7.4 處理城市變更（管理員操作）

- [x] **Task 8: 測試與驗證** (AC: #1-4)
  - [x] 8.1 測試數據自動過濾
  - [x] 8.2 測試直接訪問防護
  - [x] 8.3 測試統計數據隔離
  - [x] 8.4 測試安全日誌記錄
