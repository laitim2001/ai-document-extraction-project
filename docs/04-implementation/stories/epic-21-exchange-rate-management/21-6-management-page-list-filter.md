...
- [ ] **Task 1: 列表頁面** (AC: #1)
  - [ ] 1.1 新增 `/admin/exchange-rates/page.tsx`
  - [ ] 1.2 建立 ExchangeRateList 組件
  - [ ] 1.3 實現年份分組顯示模式
  - [ ] 1.4 實現展平列表模式

- [ ] **Task 2: 篩選器** (AC: #2)
  - [ ] 2.1 建立 ExchangeRateFilters 組件
  - [ ] 2.2 建立 CurrencySelect 組件
  - [ ] 2.3 實現篩選邏輯
...
- [ ] **Task 5: i18n** (AC: #5)
  - [ ] 5.1 新增 `messages/en/exchangeRate.json`
  - [ ] 5.2 新增 `messages/zh-TW/exchangeRate.json`
  - [ ] 5.3 新增 `messages/zh-CN/exchangeRate.json`
