...
- [x] **Task 1: 驗證 API 端點** (AC: #3, #4, #5)
  - [x] 1.1 建立 `GET /api/auth/verify-email` 端點
  - [x] 1.2 實現 Token 查詢和驗證
  - [x] 1.3 實現 emailVerified 更新
  - [x] 1.4 實現 Token 刪除
  - [x] 1.5 實現錯誤處理

- [x] **Task 2: 重新發送 API** (AC: #6, #7, #8)
  - [x] 2.1 建立 `POST /api/auth/resend-verification` 端點
  - [x] 2.2 實現用戶查詢和狀態檢查
  - [x] 2.3 實現新 Token 產生
  - [x] 2.4 實現速率限制檢查
  - [x] 2.5 整合郵件發送服務

- [x] **Task 3: 郵件模板** (AC: #1, #2)
  - [x] 3.1 建立驗證郵件 HTML 模板
  - [x] 3.2 實現多語言支援
  - [x] 3.3 加入公司品牌元素

- [x] **Task 4: 驗證結果頁面** (AC: #3, #4, #5)
  - [x] 4.1 建立 `src/app/[locale]/(auth)/auth/verify-email/page.tsx`
  - [x] 4.2 實現成功/失敗狀態顯示
  - [x] 4.3 實現重新發送功能

- [x] **Task 5: 重新發送頁面** (AC: #6, #7)
  - [x] 5.1 建立請求重新發送的表單
  - [x] 5.2 實現載入狀態和成功訊息

- [x] **Task 6: 登入頁面整合** (AC: #4, #6)
  - [x] 6.1 在登入失敗時顯示「重新發送驗證郵件」選項
  - [x] 6.2 實現未驗證用戶的引導流程

- [x] **Task 7: 翻譯文件更新** (AC: #1-7)
  - [x] 7.1 更新 `messages/*/auth.json` 郵件驗證相關翻譯

- [x] **Task 8: 驗證與測試** (AC: #1-8)
  - [x] 8.1 測試註冊後自動發送驗證郵件
  - [x] 8.2 測試驗證連結功能
  - [x] 8.3 測試 Token 過期處理
  - [x] 8.4 測試重新發送功能
