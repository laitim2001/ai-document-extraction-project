...
- [x] **Task 1: 區域經理角色設置** (AC: #1)
  - [x] 1.1 創建 REGIONAL_MANAGER 角色
  - [x] 1.2 定義角色權限
  - [x] 1.3 支援多城市分配
  - [x] 1.4 區域層級管理

- [x] **Task 2: 多城市 Session 管理** (AC: #1)
  - [x] 2.1 在 session 包含多城市列表
  - [x] 2.2 設置活躍城市選擇
  - [x] 2.3 支援城市切換
  - [x] 2.4 記住用戶城市偏好

- [x] **Task 3: 城市篩選組件** (AC: #2)
  - [x] 3.1 創建 `CityFilter.tsx` 組件
  - [x] 3.2 多選下拉選單
  - [x] 3.3 全選/取消全選功能
  - [x] 3.4 URL 參數同步
  - [x] 3.5 記住篩選偏好

- [x] **Task 4: 列表頁面整合** (AC: #2)
  - [x] 4.1 在發票列表添加城市篩選
  - [x] 4.2 在審核列表添加城市篩選
  - [x] 4.3 在統計頁面添加城市篩選
  - [x] 4.4 篩選條件持久化

- [x] **Task 5: API 多城市支援** (AC: #1, #2)
  - [x] 5.1 支援 cityCode[] 參數
  - [x] 5.2 驗證用戶有權訪問請求的城市
  - [x] 5.3 返回城市標識在結果中
  - [x] 5.4 支援城市匯總統計

- [x] **Task 6: 報表匯出功能** (AC: #3)
  - [x] 6.1 創建匯出配置對話框
  - [x] 6.2 城市選擇選項
  - [x] 6.3 匯總方式選項
  - [x] 6.4 報表城市標識

- [x] **Task 7: 報表生成服務** (AC: #3)
  - [x] 7.1 支援多城市數據聚合
  - [x] 7.2 添加城市維度分析
  - [x] 7.3 生成城市對比表格
  - [x] 7.4 PDF/Excel 格式支援 (CSV format for now, Excel library needed for xlsx)

- [x] **Task 8: 城市對比組件** (AC: #4)
  - [x] 8.1 創建 `CityComparison.tsx` 組件
  - [x] 8.2 選擇對比城市
  - [x] 8.3 顯示關鍵指標對比
  - [x] 8.4 視覺化對比圖表

- [x] **Task 9: 對比分析 API** (AC: #4)
  - [x] 9.1 創建 GET `/api/analytics/city-comparison`
  - [x] 9.2 計算城市間指標差異
  - [x] 9.3 支援時間範圍選擇
  - [x] 9.4 返回趨勢數據
