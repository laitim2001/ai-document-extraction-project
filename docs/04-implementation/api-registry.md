...
| `/api/admin/backups` | GET | 取得備份列表（支援篩選、分頁） | 是 | ADMIN | 12-5 |
| `/api/admin/backups` | POST | 建立手動備份 | 是 | GLOBAL_ADMIN | 12-5 |
| `/api/admin/backups/[id]` | GET | 取得備份詳情 | 是 | ADMIN | 12-5 |
| `/api/admin/backups/[id]` | DELETE | 刪除備份 | 是 | GLOBAL_ADMIN | 12-5 |
| `/api/admin/backups/[id]/cancel` | POST | 取消進行中的備份 | 是 | GLOBAL_ADMIN | 12-5 |
| `/api/admin/backups/[id]/restore` | POST | 還原備份 | 是 | GLOBAL_ADMIN | 12-6 |
| `/api/admin/backups/summary` | GET | 取得備份狀態摘要 | 是 | ADMIN | 12-5 |
| `/api/admin/backups/storage` | GET | 取得儲存空間使用量 | 是 | ADMIN | 12-5 |
| `/api/admin/backup-schedules` | GET | 取得備份排程列表 | 是 | ADMIN | 12-5 |
| `/api/admin/backup-schedules` | POST | 建立備份排程 | 是 | GLOBAL_ADMIN | 12-5 |
| `/api/admin/backup-schedules/[id]` | GET | 取得排程詳情 | 是 | ADMIN | 12-5 |
| `/api/admin/backup-schedules/[id]` | PUT | 更新備份排程 | 是 | GLOBAL_ADMIN | 12-5 |
| `/api/admin/backup-schedules/[id]` | DELETE | 刪除備份排程 | 是 | GLOBAL_ADMIN | 12-5 |
| `/api/admin/backup-schedules/[id]/toggle` | POST | 啟用/停用排程 | 是 | GLOBAL_ADMIN | 12-5 |
| `/api/admin/backup-schedules/[id]/run` | POST | 立即執行排程備份 | 是 | GLOBAL_ADMIN | 12-5 |
| `/api/admin/restore` | GET | 取得恢復記錄列表（支援篩選、分頁） | 是 | ADMIN | 12-6 |
| `/api/admin/restore` | POST | 建立恢復任務 | 是 | GLOBAL_ADMIN | 12-6 |
| `/api/admin/restore/[id]` | GET | 取得恢復詳情 | 是 | ADMIN | 12-6 |
| `/api/admin/restore/[id]/cancel` | POST | 取消恢復任務 | 是 | GLOBAL_ADMIN | 12-6 |
| `/api/admin/restore/[id]/logs` | GET | 取得恢復日誌 | 是 | ADMIN | 12-6 |
| `/api/admin/restore/[id]/rollback` | POST | 回滾恢復操作 | 是 | GLOBAL_ADMIN | 12-6 |
| `/api/admin/restore/preview` | POST | 預覽備份內容 | 是 | ADMIN | 12-6 |
| `/api/admin/restore/stats` | GET | 取得恢復統計 | 是 | ADMIN | 12-6 |
