...
- [ai-document-extraction-project - Epic Breakdown](#table-of-contents)
  ...
  - [Epic List](./epic-list.md)
    ...
    - [Epic 13: 文件預覽與欄位映射](./epic-list.md#epic-13-文件預覽與欄位映射)
    - [Epic 14: Prompt 配置與動態生成](./epic-list.md#epic-14-prompt-配置與動態生成)
    - [Epic 15: 統一 3 層機制到日常處理流程](./epic-list.md#epic-15-統一-3-層機制到日常處理流程)
  ...
  - [Epic 13: Document Preview & Field Mapping](./epic-13-document-preview-field-mapping.md)
    - [Story 13.1: 文件預覽組件與欄位高亮](./epic-13-document-preview-field-mapping.md#story-131-文件預覽組件與欄位高亮)
    - [Story 13.2: 欄位提取結果面板](./epic-13-document-preview-field-mapping.md#story-132-欄位提取結果面板)
    - [Story 13.3: 欄位映射配置介面](./epic-13-document-preview-field-mapping.md#story-133-欄位映射配置介面)
    - [Story 13.4: 映射配置 API](./epic-13-document-preview-field-mapping.md#story-134-映射配置-api)
    - [Story 13.5: 動態欄位映射服務整合](./epic-13-document-preview-field-mapping.md#story-135-動態欄位映射服務整合)
  - [Epic 14: Prompt Config & Dynamic Generation](./epic-14-prompt-config-dynamic-generation.md)
    - [Story 14.1: Prompt 配置模型與 API](./epic-14-prompt-config-dynamic-generation.md#story-141-prompt-配置模型與-api)
    - [Story 14.2: Prompt 配置管理介面](./epic-14-prompt-config-dynamic-generation.md#story-142-prompt-配置管理介面)
    - [Story 14.3: Prompt 解析與合併服務](./epic-14-prompt-config-dynamic-generation.md#story-143-prompt-解析與合併服務)
    - [Story 14.4: GPT Vision 服務整合](./epic-14-prompt-config-dynamic-generation.md#story-144-gpt-vision-服務整合)
  - [Epic 15: Unified 3-Tier Daily Processing](./epic-15-unified-3tier-daily-processing.md)
    - [Story 15.1: 處理流程重構 - 統一入口](./epic-15-unified-3tier-daily-processing.md#story-151-處理流程重構---統一入口)
    - [Story 15.2: 發行者識別整合](./epic-15-unified-3tier-daily-processing.md#story-152-發行者識別整合)
    - [Story 15.3: 格式匹配與動態配置](./epic-15-unified-3tier-daily-processing.md#story-153-格式匹配與動態配置)
    - [Story 15.4: 持續術語學習](./epic-15-unified-3tier-daily-processing.md#story-154-持續術語學習)
    - [Story 15.5: 信心度計算增強](./epic-15-unified-3tier-daily-processing.md#story-155-信心度計算增強)
